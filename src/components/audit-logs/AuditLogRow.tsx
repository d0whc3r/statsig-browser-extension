...
export const AuditLogRow = memo(function AuditLogRow({ auditLog, onViewDetails }: Readonly<AuditLogRowProps>) {
  ...
  return (
    <div className="flex w-full items-start gap-3 px-4 py-3 transition-colors focus-within:bg-muted/50 hover:bg-muted/50">
      <button
        type="button"
      ...
      <div className="shrink-0">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="icon" className="h-7 w-7 rounded-full" aria-label="Audit log actions">
